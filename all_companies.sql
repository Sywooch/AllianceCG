...
--
-- Table structure for table `work_companies`
--

DROP TABLE IF EXISTS `work_companies`;
...
--
-- Dumping data for table `work_companies`
--

LOCK TABLES `work_companies` WRITE;
/*!40000 ALTER TABLE `work_companies` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `work_companies` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-05-04 14:28:37
