...
$multipleDelete = file_get_contents('js/modules/references/brands/deleteRestore.js');
$this->registerJs($multipleDelete, View::POS_END);

$toggleSearch = file_get_contents('js/modules/references/brands/toggleSearch.js');
