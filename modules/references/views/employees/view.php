...
<div class="employees-view">
    ...
    <p style="text-align: right">
        <?= Html::a(Yii::t('app', '{icon} EMPLOYEES', ['icon' => '<i class="fa fa-list"></i>']), ['index'], ['class' => 'btn btn-warning btn-sm']) ?>
        <?= Html::a(Yii::t('app', '{icon} CREATE', ['icon' => '<i class="fa fa-plus"></i>']), ['create'], ['class' => 'btn btn-success btn-sm']) ?>
        <?= Html::a(Yii::t('app', '{icon} UPDATE', ['icon' => '<i class="fa fa-edit"></i>']), ['update', 'id' => $model->id], ['class' => 'btn btn-primary btn-sm']) ?>
